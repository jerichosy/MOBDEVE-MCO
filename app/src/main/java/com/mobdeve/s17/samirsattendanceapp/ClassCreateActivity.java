...
public class ClassCreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_scheduleDays = findViewById(R.id.et_scheduleDays);
        et_scheduleStartTime = findViewById(R.id.et_scheduleStartTime);
        et_scheduleEndTime = findViewById(R.id.et_scheduleEndTime);
        et_learningMode = findViewById(R.id.et_learningMode);
        ...
        btn_createClass.setOnClickListener(v -> {
            ...
            db.collection("classes").add(newClass).addOnSuccessListener(documentReference -> Toast.makeText(getApplicationContext(), "Class created!", Toast.LENGTH_SHORT).show())
            .addOnFailureListener(e -> Toast.makeText(getApplicationContext(), "Class creation failed!", Toast.LENGTH_SHORT).show());
            finish();
        });
    }
